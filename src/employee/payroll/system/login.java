...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        cmd_Login.setBounds(120, 470, 100, 30);

        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("NOMBRE:");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(10, 360, 70, 20);

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("CONTRASEÑA:");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(10, 400, 120, 20);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Por favor ingresa usuario y contraceña");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 320, 219, 14);
        ...
        txt_username.setBounds(120, 350, 132, 30);
        ...
        txt_password.setBounds(120, 390, 132, 30);
        ...
        try{
          ...
          String access=(txt_combo.getSelectedItem().toString());
           ...
           if(access=="Admin") {
               ...
               if(count==1){
                   JOptionPane.showMessageDialog(null,"INICIO SECION CORRECTAMENTE" );
               ...
               JOptionPane.showMessageDialog(null,"NOMBRE O CONTRASEÑA INCORRECTA");
                   ...
                   if(count ==1){
                   JOptionPane.showMessageDialog(null,"AUTENTIFICADO");
                   MainMenu j = new MainMenu();
                   j.setVisible (true); 
           ...
           if(access =="Admin") {
               ...
               if(count==1){
                  ...
                  String values = dateString;
                   ...
                   JOptionPane.showMessageDialog(null,"USUARIO DUPLICADO O CONTRASEÑA INCORRECTA");
                   }
           
        
           else{
               JOptionPane.showMessageDialog(null,"NOMBRE Y USUARIO INCORRECTA");
